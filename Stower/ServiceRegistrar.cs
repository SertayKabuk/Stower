...
namespace Stower
{
    ...
    {
        public static void AddStowerClasses(IServiceCollection services, Assembly[] assembliesToScan)
        {
            ConnectImplementationsToTypesClosing(typeof(IToppleHandler<>), services, assembliesToScan, false);
        }
